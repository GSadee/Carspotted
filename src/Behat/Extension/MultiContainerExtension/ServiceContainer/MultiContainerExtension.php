...
namespace Behat\Extension\MultiContainerExtension\ServiceContainer;

use Behat\Testwork\Environment\ServiceContainer\EnvironmentExtension;
use Behat\Testwork\EventDispatcher\ServiceContainer\EventDispatcherExtension;
use Behat\Testwork\ServiceContainer\Extension;
use Behat\Testwork\ServiceContainer\ExtensionManager;
use Behat\Extension\MultiContainerExtension\ContainerConfiguration;
use Behat\Extension\MultiContainerExtension\Context\Environment\Handler\ContextServiceEnvironmentHandler;
use Behat\Extension\MultiContainerExtension\ContextRegistry;
use Behat\Extension\MultiContainerExtension\Loader\XmlFileLoader;
use Behat\Extension\MultiContainerExtension\ScopeManipulator;
...
final class MultiContainerExtension implements Extension
{
    ...
    public function process(ContainerBuilder $container)
    {
        ...
        $taggedServices = $container->findTaggedServiceIds('app.behat.context');
