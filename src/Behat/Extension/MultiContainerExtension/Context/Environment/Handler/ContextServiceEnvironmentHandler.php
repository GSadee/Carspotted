...
namespace Behat\Extension\MultiContainerExtension\Context\Environment\Handler;
...
use Behat\Extension\MultiContainerExtension\Context\Environment\UninitializedContextServiceEnvironment;
